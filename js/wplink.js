...
(function($){
	...
	wpLink = {
		...
		//mod wplink original --- for my plugin
		// --- append function of add link nofollow case
		append : function() {
		...
		init : function() {
			...
			// --- add checkbox option nofollow 
			inputs.relNofollow = $('#link-nofollow-checkbox'); 
		...
		getAttrs : function() {
			return {
				...
				// --- add att rel
				rel : inputs.relNofollow.prop('checked') ? 'nofollow' : ''
			};
		},
